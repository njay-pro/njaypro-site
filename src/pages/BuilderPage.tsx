  ...
  const identityNodes = [
    {
      ...
      title: 'steel & structural tension',
      payload: 'Before pixels, material taught me that every line has to hold. Welder at 19, learning where structure fails.',
      signal: 'amber' as const,
    },
    {
      id: '02',
      category: '02 / VISUAL SYSTEMS',
      title: 'identity is communication',
      payload: 'Not decoration. Visual architecture, layout typography, brand logic. Working inside agency grids.',
    ...
    },
    {
      ...
      payload: 'Blender geometry nodes made math spatial: fields, constraints, instanced generation, generative form.',
      signal: 'cyan' as const,
    },
    {
      id: '04',
      category: '04 / AGENT SYSTEMS',
      title: 'engineering democratized',
      payload: 'AI tools made the engineering layer accessible. Bridging the gap, building agentic foundries.',
      signal: 'mint' as const,
    },
  ];
